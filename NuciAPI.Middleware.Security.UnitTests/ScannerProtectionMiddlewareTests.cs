...
namespace NuciAPI.Middleware.Security.UnitTests
{
    ...
    public sealed class ScannerProtectionMiddlewareTests
    {
        ...
        [TestCase("/__aws_leak_probe_f7c28a83__")]
        ...
        [TestCase("/app/.git/config")]
        [TestCase("/backend/.git/config")]
        [TestCase("/htdocs/.git/config")]
        [TestCase("/public/.git/config")]
        [TestCase("/repo/.git/HEAD")]
        [TestCase("/site/.git/config")]
        [TestCase("/src/.git/config")]
        [TestCase("/var/www/.git/config")]
        [TestCase("/wordpress/.git/config")]
        [TestCase("/www/.git/config")]
        [TestCase("/.htpasswd")]
        ...
        [TestCase("/administrator/components/com_jce/index.html")]
        [TestCase("/api-keys.txt")]
        [TestCase("/api/.env")]
        [TestCase("/api/actuator/configprops")]
        [TestCase("/api/actuator/env")]
        [TestCase("/api/session/properties")]
